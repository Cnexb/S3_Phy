...
const UI = {
  en: {
    appSubtitle: "S3 Foundations · Quantities, units and maths · English / 繁體中文 UI",
    ...
    revBandFair: "Mixed performance: re-read the Foundations notes (quantities, prefixes, and graphs), then regenerate.",
    revBandLow:
      "Several ideas need consolidation. Review SI units, prefixes, scientific notation, and slope of a straight line before the next round.",
  ...
  zh: {
    ...
    revBandFair: "表现参差：请重温物理量、字首与直线斜率笔记后再生成题目。",
    revBandLow: "多个概念仍需巩固。请先温习 SI 单位、字首、科学记数法与斜率。",
  ...
  "zh-Hant": {
    ...
    revBandFair: "表現參差：請重溫物理量、字首與直線斜率筆記後再產生題目。",
    revBandLow: "多個概念仍需鞏固。請先溫習 SI 單位、字首、科學記數法與斜率。",
