...
export const en = {
  ...
  'strands.intro': 'Optics (light) and Heat are ready. Foundations, Mechanics, Gas, and Waves are coming soon, but you can still open them.',
  ...
  'strand.foundations.desc': 'Physical quantities, SI units, and the mathematics used in S3 physics. (Coming soon — not ready yet.)',
