...
export const en = {
  ...
  'strands.intro': 'Foundations, Light and Optics, and Heat are ready. Other strands are coming soon, but you can still open them.',
  ...
  'strand.heat.desc': 'Thermometer, heat and internal energy, change of state, heat transfer',
  'strand.heat.subtitle': 'Heat — temperature and energy transfer',
  'strand.open': 'Open strand',
  'strand.back': 'All strands',
  'strand.comingSoon': 'Coming soon',
  'strand.notReady': 'Not ready yet',
  ...
  'profile.themeToDark': 'Switch to dark mode',
  'profile.themeToLight': 'Switch to light mode',
  ...
  'notes.downloadPdf': 'Download PDF',
  'notes.embedHint': 'If the preview is blank, open or download the PDF.',
  'notes.missing': 'PDF not uploaded yet.',
  'notes.comingSoon': 'Study notes for this strand are coming soon.',
  ...
  'tools.rippleTank.title': 'Ripple tank — wave properties',
  ...
  'tools.rayDiagram.title': 'Image formed by plane mirror',
  ...
  'quiz.practiceTitle': 'JPHG01 Temperature and thermometer',
  'quiz.practiceTitle2': 'JPHG01 Temperature and thermometer · Quiz 2',
  'quiz.practiceTitle3': 'JPHG01 Temperature and thermometer · Quiz 3',
  'quiz.jphg01Quiz1': 'JPHG01 Quiz 1',
  'quiz.jphg01Quiz2': 'JPHG01 Quiz 2',
  'quiz.jphg01Quiz3': 'JPHG01 Quiz 3',
  'quiz.opticsCh3Title': 'JPWM06 Light reflection',
  'quiz.opticsCh3Title2': 'JPWM06 Light reflection · Quiz 2',
  'quiz.opticsCh3Title3': 'JPWM06 Light reflection · Quiz 3',
  'quiz.jpwm06Quiz1': 'JPWM06 Quiz 1',
  ...
  'comics.title': 'Comics',
  'comics.intro': 'Topic comics for this strand. Preview below or open in a new tab.',
  'comics.viewImage': 'Open full image',
  'comics.openPdf': 'Open / download PDF',
  'comics.missing': 'Comic not uploaded yet.',
  ...
  'tools.heatingMaterials.title': 'The relationship between specific heat capacity and temperature difference',
  ...
  'tools.heatFlow.title': 'Heat Flow & Thermal Equilibrium',
  ...
  'tools.thermometerLab.labels.largeBulb': 'Large bulb (more liquid → higher sensitivity)',
  ...
  'strand.foundations.desc': 'Quantities and units, useful mathematics in physics',
  ...
  'tools.siUnits.title': 'Quantities and units',
  ...
  'notes.card.quantitiesUnits': 'F01 Notes-Quantities and Units',
  'notes.card.usefulMaths': 'F02 Notes-Useful Mathematics in Physics',
  ...
  'tools.seesawMoment.title': 'Seesaw — principle of moments',
  'tools.ladderMoment.title': 'Ladder — moments and equilibrium',
  'tools.supportsMoment.title': 'Supports — moments and reactions',
  'tools.impulseMomentum.title': 'Impulse and change in momentum',
  'tools.crashTrackMomentum.title': 'Crash track — collisions',
  'tools.bulletMomentum.title': 'Bullet swing — ballistic pendulum',
  'tools.projectileMotion.title': 'Projectile motion',
  'tools.orbitalForces.title': 'Orbital Forces Lab — gravity & centripetal',
  'tools.bungeeEnergy.title': 'Bungee — gravitational, kinetic and elastic energy',
  'tools.divingEnergy.title': 'Diving board — energy and the water',
  'tools.pendulumEnergy.title': 'Pendulum — kinetic and gravitational energy',
  'tools.skateParkEnergy.title': 'Skate park — conservation of energy',
  'tools.aircraftTurn.title': 'Aircraft turn — banking and centripetal force',
  'tools.conicalPendulum.title': 'Conical pendulum — tension and centripetal force',
  ...
  'gas.comingSoon': 'Worksheets, quizzes, and flashcards for this strand are coming soon.',
  'tools.boylesLaw.title': "Boyle's law — squeeze the syringe",
  'tools.charlesLaw.title': "Charles' law — volume and Kelvin temperature",
  'tools.pressureLaw.title': 'Pressure law — heat a sealed vessel',
  'tools.connectedContainers.title': 'Connected containers — open the tap',
  'tools.kineticTheory.title': 'Kinetic theory — molecules and the gas laws',
  ...
  'topic.electromagnetism': 'Electromagnetism',
  'topic.electromagneticInduction': 'Electromagnetic induction',
  'notes.card.electrostatics': 'Electrostatics',
  'notes.card.electricCircuits': 'Electric circuits',
  'notes.card.domesticElectricity': 'Domestic electricity',
  'notes.card.electromagnetism': 'Electromagnetism',
  'notes.card.electromagneticInduction': 'Electromagnetic induction',
  'summary.item.electrostatics': 'Electrostatics',
  'summary.item.electricCircuits': 'Electric circuits',
  'summary.item.domesticElectricity': 'Domestic electricity',
  'summary.item.electromagnetism': 'Electromagnetism',
  ...
  'notes.card.radiationRadioactivity': 'Radiation and radioactivity',
  'notes.card.atomicModel': 'Atomic model',
  'notes.card.nuclearEnergy': 'Nuclear energy',
  'summary.item.radiationRadioactivity': 'Radiation and radioactivity',
  'summary.item.atomicModel': 'Atomic model',
  'summary.item.nuclearEnergy': 'Nuclear energy',
};
