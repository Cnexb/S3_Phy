...
export function createHeatCh1Quiz3(t) {
  ...
  wrap.className = 'tool-jphg01-quiz-3';

  const iframe = document.createElement('iframe');

  function iframeSrc() {
    return embedPageUrl(`jphg01-quiz-3/quiz.html?embed=1&v=${JPHG01_QUIZ_3_VERSION}`);
  }

  iframe.src = iframeSrc();
  iframe.title = t('quiz.practiceTitle3');
  ...
  wrap._heatCh1Quiz3Cleanup = () => window.removeEventListener('s3phy:lang', onLang);
