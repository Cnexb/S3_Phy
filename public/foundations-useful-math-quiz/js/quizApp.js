...
const UI = {
  en: {
    appSubtitle: "S3 Foundations · Useful mathematics · English / 繁體中文 UI",
    ...
    revBandFair: "Mixed performance: re-read Useful mathematics in physics, then regenerate.",
    revBandLow:
      "Several ideas need consolidation. Review y = mx + b, slope as Δy/Δx, intercepts, and rearranging Ax + By + C = 0 before the next round.",
  ...
  zh: {
    ...
    revBandFair: "表现参差：请重温「物理中常用的数学」后再生成题目。",
    revBandLow: "多个概念仍需巩固。请先温习 y = mx + b、斜率 Δy/Δx、截距，以及把 Ax + By + C = 0 改写。",
  ...
  "zh-Hant": {
    appSubtitle: "S3 物理基礎 · 物理中常用的數學 · 介面繁體中文",
    hSettings: "工作紙設定",
    lblTypes: "課題",
    lblFormats: "題型",
    ...
    revBandFair: "表現參差：請重溫「物理中常用的數學」後再產生題目。",
    revBandLow: "多個概念仍需鞏固。請先溫習 y = mx + b、斜率 Δy/Δx、截距，以及把 Ax + By + C = 0 改寫。",
...
export function initQuiz() {
  ...
  const QUIZ_META = { subject: "PHY", quizId: "phy-foundations-useful-math" };
