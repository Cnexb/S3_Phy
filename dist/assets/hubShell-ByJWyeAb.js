import{t as o,g as x,s as M,p as _,m as C}from"./index-CaG8kA4T.js";const k=new Map;function L(){return x()==="zh-Hant"?"zhHant":"en"}function N(e){if(e)for(const t of Object.keys(e))t.endsWith("Cleanup")&&typeof e[t]=="function"&&e[t]()}function O(e,t,s){try{const i=sessionStorage.getItem(e);if(i&&t.includes(i))return i}catch{}return s}function R(e,t){try{sessionStorage.setItem(e,t)}catch{}}async function w(e,t){if(!t)return!1;const s=`./${e}/${t}`;if(k.has(s))return k.get(s);try{const r=(await fetch(s,{method:"HEAD"})).ok;return k.set(s,r),r}catch{return k.set(s,!1),!1}}async function E(e){return w("notes",e)}function W(e){return`${String(e).split("#")[0]}#view=FitH&toolbar=0&navpanes=0&scrollbar=0`}function q(e,t,s){const i=W(t);return`
