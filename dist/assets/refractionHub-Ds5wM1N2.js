const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./opticsLightLensWorksheet-CHeIfNrQ.js","./index-DnTYw8l2.js","./index-D16P_DNl.css","./refractionLab-BtY8bUaA.js","./createLabIframe-BnyZMF-N.js","./tirEscapeLab-BwM7ttUu.js"])))=>i.map(i=>d[i]);
import{t as e,_ as y,g as P}from"./index-DnTYw8l2.js";import{l as j,m as z,c as V,s as g,h as Z,a as W}from"./hubShell-BRVvORhA.js";import{r as Y,h as U}from"./toolsShell-C-Th6Ujm.js";import{m as q,b as x}from"./flashcardDeck-0VQ6zH7A.js";const _=["refraction","refractionTir"],v="s3phy.refraction.tool",F=["lightLens"],G="20260627-em-v2",k=[{key:"refraction",fileEn:"refraction-en.pdf",fileZh:"refraction-zhHant.pdf"},{key:"tir",fileEn:"tir-en.pdf",fileZh:"tir-zhHant.pdf"}],E=[{key:"refraction",type:"image",fileEn:"refraction-en.webp",fileZh:"refraction-zhHant.webp"},{key:"tir",type:"image",fileEn:"tir-en.webp",fileZh:"tir-zhHant.webp"}],S={lightLens:()=>y(()=>import("./opticsLightLensWorksheet-CHeIfNrQ.js"),__vite__mapDeps([0,1,2]),import.meta.url).then(o=>o.createOpticsLightLensWorksheet)},B={refraction:()=>y(()=>import("./refractionLab-BtY8bUaA.js"),__vite__mapDeps([3,4,1,2]),import.meta.url).then(o=>o.createRefractionLab),refractionTir:()=>y(()=>import("./tirEscapeLab-BwM7ttUu.js"),__vite__mapDeps([5,4,1,2]),import.meta.url).then(o=>o.createTirEscapeLab)};function O(o){return e({refraction:"tools.refraction.title",refractionTir:"tools.refractionTir.title"}[o]||o)}function J(o){return e({lightLens:"worksheets.opticsLightLensTitle"}[o]||o)}function nt(o){let n=sessionStorage.getItem("s3phy.refraction.section")||"topics",d=j(v,_,"refraction"),f="lightLens",a=null,c={main:null},m=null,l=null,r=null;const w=[{value:"refractionTir",labelKey:"flashcards.deck.refractionTir"}];function h(){V(m),m=null}async function R(t){t.innerHTML="",h();const i=B[d];if(!i)return;const s=(await i())(e);m=s,t.appendChild(s)}async function $(t){if(!t)return;r==null||r(),r=null,t.innerHTML="";const i=S[f];if(!i)return;const s=(await i())(e);t.appendChild(s),r=s._opticsLightLensWorksheetCleanup||null}function A(){const t=F.map(i=>`<button type="button" data-worksheet="${i}" class="${f===i?"active":""}">${J(i)}</button>`).join("");return`
