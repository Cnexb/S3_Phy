const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./boylesLawLab-CPgcU4i2.js","./createLabIframe-4BGk7J14.js","./index-zsDP7smh.js","./index-DfYqHF8R.css","./embedPageUrl-DWRMbVg6.js","./charlesLawLab-Bui1yK2a.js","./pressureLawLab-BH0HmxMv.js","./connectedContainersLab-YHKPlODq.js","./kineticTheoryLab-DxGSRP85.js"])))=>i.map(i=>d[i]);
import{t as a,_ as l}from"./index-zsDP7smh.js";import{r as T,l as g,m as w,c as E,a as S,h as O,b as I,s as A}from"./toolsShell-C8mSMZiu.js";const L="s3phy.gas.tool",m=["boylesLaw","charlesLaw","pressureLaw","connectedContainers","kineticTheory"],C={boylesLaw:()=>l(()=>import("./boylesLawLab-CPgcU4i2.js"),__vite__mapDeps([0,1,2,3,4]),import.meta.url).then(e=>e.createBoylesLawLab),charlesLaw:()=>l(()=>import("./charlesLawLab-Bui1yK2a.js"),__vite__mapDeps([5,1,2,3,4]),import.meta.url).then(e=>e.createCharlesLawLab),pressureLaw:()=>l(()=>import("./pressureLawLab-BH0HmxMv.js"),__vite__mapDeps([6,1,2,3,4]),import.meta.url).then(e=>e.createPressureLawLab),connectedContainers:()=>l(()=>import("./connectedContainersLab-YHKPlODq.js"),__vite__mapDeps([7,1,2,3,4]),import.meta.url).then(e=>e.createConnectedContainersLab),kineticTheory:()=>l(()=>import("./kineticTheoryLab-DxGSRP85.js"),__vite__mapDeps([8,1,2,3,4]),import.meta.url).then(e=>e.createKineticTheoryLab)};function h(e){return a({boylesLaw:"tools.boylesLaw.title",charlesLaw:"tools.charlesLaw.title",pressureLaw:"tools.pressureLaw.title",connectedContainers:"tools.connectedContainers.title",kineticTheory:"tools.kineticTheory.title"}[e]||e)}const y=[{id:"gasLaws",titleKey:"topic.gasLaws",fileEn:"gas-laws-en.pdf",fileZh:"gas-laws-zhHant.pdf"},{id:"kineticTheory",titleKey:"topic.kineticTheory",fileEn:"kinetic-theory-en.pdf",fileZh:"kinetic-theory-zhHant.pdf"}];function $(e){let n=T(sessionStorage.getItem("s3phy.gas.section")),s=g(L,m,"boylesLaw"),o=null,r={main:null},c=null;function d(){E(c),c=null}async function _(t){t.innerHTML="",d();const i=C[s];if(!i)return;c=(await i())(a),t.appendChild(c)}function u(){r.main&&(n==="notes"?(r.main.innerHTML=f(),v()):n==="tools"?(r.main.innerHTML=S({toolOrder:m,toolId:s,getLabel:h,t:a}),O(e,{getLabel:h,t:a,getActiveToolId:()=>s,onSelectTool:t=>{s=t,A(L,s)},mountTool:t=>{_(t)}})):r.main.innerHTML=`
        <section class="panel">
          <h2>${a(`nav.${n}`)}</h2>
