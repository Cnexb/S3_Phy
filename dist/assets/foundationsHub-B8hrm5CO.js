const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./foundationsNotesWorksheet-BjNwfdDB.js","./index-CaG8kA4T.js","./index-D1cq4Sb3.css","./foundationsQuantitiesQuiz-pd228HZh.js"])))=>i.map(i=>d[i]);
import{t,_ as h,g as $}from"./index-CaG8kA4T.js";import{r as q,m as H,h as E,a as L}from"./hubShell-ByJWyeAb.js";import{m as M,b as N}from"./flashcardDeck-BElANj7H.js";const f=[{id:"quantitiesUnits",titleKey:"topic.quantitiesUnits",fileEn:"quantities-units-en.pdf",fileZh:"quantities-units-zhHant.pdf"},{id:"usefulMaths",titleKey:"topic.usefulMaths",fileEn:"useful-mathematics-en.pdf",fileZh:"useful-mathematics-zhHant.pdf"}],O=[{key:"quantitiesUnits",type:"image",fileEn:"quantities-units-en.webp",fileZh:"quantities-units-zhHant.webp"},{key:"usefulMaths",type:"image",fileEn:"useful-mathematics-en.webp",fileZh:"useful-mathematics-zhHant.webp"}],T=[{value:"all",labelKey:"flashcards.all"},{value:"quantitiesUnits",labelKey:"topic.quantitiesUnits"},{value:"usefulMaths",labelKey:"topic.usefulMaths"}];function K(r){let a=q(sessionStorage.getItem("s3phy.foundations.section")),n=null,i={main:null},s=null,o=null,l=null;async function y(e){const{createFoundationsNotesWorksheet:u}=await h(async()=>{const{createFoundationsNotesWorksheet:p}=await import("./foundationsNotesWorksheet-BjNwfdDB.js");return{createFoundationsNotesWorksheet:p}},__vite__mapDeps([0,1,2]),import.meta.url),d=u(t);e.appendChild(d),o=d._foundationsNotesWorksheetCleanup||null}async function v(e){const{createFoundationsQuantitiesQuiz:u}=await h(async()=>{const{createFoundationsQuantitiesQuiz:p}=await import("./foundationsQuantitiesQuiz-pd228HZh.js");return{createFoundationsQuantitiesQuiz:p}},__vite__mapDeps([3,1,2]),import.meta.url),d=u(t);e.appendChild(d),s=d._foundationsQuantitiesQuizCleanup||null}function c(){if(i.main)if(s==null||s(),s=null,o==null||o(),o=null,l==null||l(),l=null,a==="notes")i.main.innerHTML=g(),S();else if(a==="summary")i.main.innerHTML=_(),w();else if(a==="worksheets"){i.main.innerHTML='<section class="panel panel--worksheets-embed"></section>';const e=i.main.querySelector(".panel--worksheets-embed");y(e)}else if(a==="quiz"){i.main.innerHTML='<section class="panel panel--quiz-embed"></section>';const e=i.main.querySelector(".panel--quiz-embed");v(e)}else a==="flashcards"?l=M(i.main,{deckOptions:T.map(e=>({value:e.value,label:t(e.labelKey)})),buildDeck:e=>N(e,$()),introKey:"flashcards.introFoundations"}):i.main.innerHTML=`
        <section class="panel">
          <h2>${t(`nav.${a}`)}</h2>
