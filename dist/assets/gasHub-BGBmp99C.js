import{t as i}from"./index-Dul0mlIo.js";import{r as f,m,b as u}from"./hubShell-DOl-a0CW.js";const c=[{id:"gasLaws",titleKey:"topic.gasLaws",fileEn:"gas-laws-en.pdf",fileZh:"gas-laws-zhHant.pdf"},{id:"kineticTheory",titleKey:"topic.kineticTheory",fileEn:"kinetic-theory-en.pdf",fileZh:"kinetic-theory-zhHant.pdf"}];function v(d){let t=f(sessionStorage.getItem("s3phy.gas.section")),e=null,a={main:null};function s(){a.main&&(t==="notes"?(a.main.innerHTML=p(),g()):a.main.innerHTML=`
      ...
      </section>`}async function g(){const n=c.map(r=>({key:r.id,fileEn:r.fileEn,fileZh:r.fileZh}));await u(d,n)}return window.addEventListener("s3phy:lang",o),l(),()=>{window.removeEventListener("s3phy:lang",o),e==null||e.destroy()}}export{v as mountGasHub};
