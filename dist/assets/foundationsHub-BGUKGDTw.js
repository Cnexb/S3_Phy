const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./foundationsNotesWorksheet-CnkG3FZb.js","./index-Bi7egCS9.js","./index-BMJ7OUGl.css","./foundationsUsefulMathQuiz-W7mYX9wW.js","./foundationsQuantitiesQuiz-Yagb68Mt.js"])))=>i.map(i=>d[i]);
import{t as a,_ as h,g as k}from"./index-Bi7egCS9.js";import{r as L,m as N,F as S,h as T,a as H}from"./hubShell-BM01ToX-.js";import{m as C,b as F}from"./flashcardDeck-D6zh_C8f.js";const v=[{id:"quantitiesUnits",titleKey:"topic.quantitiesUnits",fileEn:"quantities-units-en.pdf",fileZh:"quantities-units-zhHant.pdf"},{id:"usefulMaths",titleKey:"topic.usefulMaths",fileEn:"useful-mathematics-en.pdf",fileZh:"useful-mathematics-zhHant.pdf"}],A=[{key:"quantitiesUnits",type:"image",fileEn:"quantities-units-en.webp",fileZh:"quantities-units-zhHant.webp"},{key:"usefulMaths",type:"image",fileEn:"useful-mathematics-en.webp",fileZh:"useful-mathematics-zhHant.webp"}],D=[{value:"all",labelKey:"flashcards.all"},{value:"quantitiesUnits",labelKey:"topic.quantitiesUnits"},{value:"usefulMaths",labelKey:"topic.usefulMaths"}],y=["quantitiesUnits","usefulMaths"],q="s3phy.foundations.quiz";function K(l){return y.includes(l)?l:"quantitiesUnits"}function P(l){let u=L(sessionStorage.getItem("s3phy.foundations.section"),"notes",S),m=K(sessionStorage.getItem(q)),n=null,o={main:null},i=null,c=null,d=null;async function g(t){const{createFoundationsNotesWorksheet:e}=await h(async()=>{const{createFoundationsNotesWorksheet:r}=await import("./foundationsNotesWorksheet-CnkG3FZb.js");return{createFoundationsNotesWorksheet:r}},__vite__mapDeps([0,1,2]),import.meta.url),s=e(a);t.appendChild(s),c=s._foundationsNotesWorksheetCleanup||null}async function w(t){if(!t)return;if(i==null||i(),i=null,t.innerHTML="",m==="usefulMaths"){const{createFoundationsUsefulMathQuiz:r}=await h(async()=>{const{createFoundationsUsefulMathQuiz:U}=await import("./foundationsUsefulMathQuiz-W7mYX9wW.js");return{createFoundationsUsefulMathQuiz:U}},__vite__mapDeps([3,1,2]),import.meta.url),_=r(a);t.appendChild(_),i=_._foundationsUsefulMathQuizCleanup||null;return}const{createFoundationsQuantitiesQuiz:e}=await h(async()=>{const{createFoundationsQuantitiesQuiz:r}=await import("./foundationsQuantitiesQuiz-Yagb68Mt.js");return{createFoundationsQuantitiesQuiz:r}},__vite__mapDeps([4,1,2]),import.meta.url),s=e(a);t.appendChild(s),i=s._foundationsQuantitiesQuizCleanup||null}function E(){const t=y.map(e=>`<button type="button" data-quiz="${e}" class="${m===e?"active":""}">${a(`topic.${e}`)}</button>`).join("");return`
