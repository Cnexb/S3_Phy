import{t as s,g as L,s as _,a as C}from"./index-CAfFDNgh.js";const w=new Map;function q(){return L()==="zh-Hant"?"zhHant":"en"}function N(e){if(e)for(const t of Object.keys(e))t.endsWith("Cleanup")&&typeof e[t]=="function"&&e[t]()}function O(e,t,a){try{const i=sessionStorage.getItem(e);if(i&&t.includes(i))return i}catch{}return a}function R(e,t){try{sessionStorage.setItem(e,t)}catch{}}async function S(e,t){if(!t)return!1;const a=`./${e}/${t}`;if(w.has(a))return w.get(a);try{const r=(await fetch(a,{method:"HEAD"})).ok;return w.set(a,r),r}catch{return w.set(a,!1),!1}}async function M(e){return S("notes",e)}function W(e){return`${String(e).split("#")[0]}#view=FitH&toolbar=0&navpanes=0&scrollbar=0`}function H(e,t,a){const i=W(t);return`
