...
const UI = {
  en: {
    appSubtitle: "S3 Foundations · Quantities and units · English / 繁體中文 UI",
    ...
    revBandFair: "Mixed performance: re-read Ch.00 Quantities and units, then regenerate.",
    revBandLow:
      "Several ideas need consolidation. Review SI units, prefixes, scientific notation, and km/h to m/s before the next round.",
  ...
  zh: {
    ...
    revBandFair: "表现参差：请重温 Ch.00 物理量与单位后再生成题目。",
    revBandLow: "多个概念仍需巩固。请先温习 SI 单位、字首、科学记数法，以及 km/h 换算 m/s。",
  ...
  "zh-Hant": {
    appSubtitle: "S3 物理基礎 · 物理量與單位 · 介面繁體中文",
    hSettings: "工作紙設定",
    lblTypes: "課題",
    lblFormats: "題型",
    ...
    revBandFair: "表現參差：請重溫 Ch.00 物理量與單位後再產生題目。",
    revBandLow: "多個概念仍需鞏固。請先溫習 SI 單位、字首、科學記數法，以及 km/h 換算 m/s。",
